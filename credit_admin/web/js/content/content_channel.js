			...
			var content_page={
				...
				content_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:"http://10.0.5.226:8016/yttx-adminbms-api/article/type/list",
							dataType:'JSON',
							method:'post',
			...
			$content_wrap.delegate('span','click',function(e){
				...
				if(action==='update'){
					...
					dialogObj.setFn(function(){
						...
						$.ajax({
								url:"http://10.0.5.226:8016/yttx-adminbms-api/article/type/operate",
								method: 'POST',
								dataType: 'json',
								data:{
									"typeId":id,
					...
					$.extend(true,form_opt,public_tool.cache.form_opt_0,{
						submitHandler: function(form){
							...
							if(id!==''){
								//此处配置修改稿角色地址（开发阶段）
								var config={
									url:"http://10.0.5.226:8016/yttx-adminbms-api/article/type/update",
									dataType:'JSON',
									method:'post',
									data:{
										typeId:id,
								...
								//此处配置添加角色地址（开发阶段）
								var config={
									url:"http://10.0.5.226:8016/yttx-adminbms-api/article/type/add",
									dataType:'JSON',
									method:'post',
									data:{
										typeId:id,
