	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			var powermap=public_tool.getPower(),
				updown_power=public_tool.getKeyPower('首页图片广告上架/下架',powermap),
				update_power=public_tool.getKeyPower('首页图片广告修改',powermap);
