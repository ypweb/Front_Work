...
(function () {
    ...
    angular
        .module('app')
        .service('providerListService', providerListService);


    /*服务注入依赖*/
    providerListService.$inject = ['toolUtil', 'toolDialog', 'assistCommon', 'dataTableService', '$state', 'providerService', 'loginService', 'testService'];


    /*服务实现*/
    function providerListService(toolUtil, toolDialog, assistCommon, dataTableService, $state, providerService, loginService, testService) {
