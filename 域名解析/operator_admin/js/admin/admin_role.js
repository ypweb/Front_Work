	...
	$(function(){
		...
		if(public_tool.initMap.isrender){
			...
			table=$admin_role_wrap.DataTable({
				...
				ajax:{
					url:"http://112.74.207.132:8082/mall-agentbms-api/roles",
					dataType:'JSON',
					method:'post',
					dataSrc:function ( json ) {
						var code=parseInt(json.code,10);
						...
						if(action==='delete'){
							...
							setSure.sure('delete',function (cf) {
								...
								if(isrole){
									//删除角色
									config={
										url:"http://112.74.207.132:8082/mall-agentbms-api/role/delete",
										method: 'POST',
										dataType: 'json',
										data:{
											"roleId":id,
									...
									//删除成员
									config={
										url:"http://112.74.207.132:8082/mall-agentbms-api/sysuser/delete",
										method: 'POST',
										dataType: 'json',
										data:{
											"userId":id,
							...
							if(isrole){
								...
								if(action==='select'){
									...
									if(member_config.url===''){
										member_config.url='http://112.74.207.132:8082/mall-agentbms-api/sysusers';
									}
					...
					$.extend(true,form_opt_0,public_tool.cache.form_opt_0,{
						submitHandler: function(form){
							...
							if(id!==''){
								//修改角色
								config={
											url:"http://112.74.207.132:8082/mall-agentbms-api/role/update",
											method: 'POST',
											dataType: 'json',
											data:{
												"roleId":id,
								...
								//添加角色
								config={
									url:"http://112.74.207.132:8082/mall-agentbms-api/role/add",
									method: 'POST',
									dataType: 'json',
									data:{
										"roleId":decodeURIComponent(logininfo.param.roleId),
					...
					$.extend(true,form_opt_1,public_tool.cache.form_opt_1,{
						submitHandler: function(form){
							...
							if(id!==''){
								//修改成员
								config={
									url:"http://112.74.207.132:8082/mall-agentbms-api/sysuser/update",
									method: 'POST',
									dataType: 'json',
									data:{
										"userId":id,
								...
								//添加成员
								config={
									url:"http://112.74.207.132:8082/mall-agentbms-api/sysuser/add",
									method: 'POST',
									dataType: 'json',
									data:{
		...
		function showDetail(id,$tr,type) {
			...
			if(type==='select'){
				detailconfig={
					url:"http://112.74.207.132:8082/mall-agentbms-api/sysuser/info",
					dataType:'JSON',
					method:'post',
					data:{
						"userId":id,
				...
				detailconfig={
					url:"http://112.74.207.132:8082/mall-agentbms-api/role/info",
					dataType:'JSON',
					method:'post',
					data:{
						"roleId":id,
