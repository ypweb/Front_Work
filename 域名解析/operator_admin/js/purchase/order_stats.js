			...
			var order_page={
				...
				order_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:"http://112.74.207.132:8082/mall-agentbms-api/goodsorder/list",
							dataType:'JSON',
							method:'post',
				...
				if(action==='send'&&id!==''){
					...
					(function () {
						...
						if(subclass){
							...
							if(subitem===''){
								$.ajax({
										url:"http://112.74.207.132:8082/mall-agentbms-api/goodsorder/details",
										dataType:'JSON',
										method:'post',
										data:{
											id:id,
							...
							submitHandler: function(form){
								setSure.sure('发货',function(cf){
									...
									if(formtype==='ordersend'){
										...
										config['url']="http://112.74.207.132:8082/mall-agentbms-api/order/tracking/add";
										config['data']=setdata;
									}
