(function($){
	...
	$(function(){
			...
			var activity_page={
				...
				activity_config={
					...
					config:{
						...
						paging:false,
						ajax:{
							url:"http://112.74.207.132:8081/mall-buzhubms-api/module/set/list",
							dataType:'JSON',
							method:'post',
						...
						columns: [
							...
							},
							{
								...
								"render":function(data, type, full, meta ){
									...
									if(manage_power){
										if(def!==1){btns+='<span data-action="setdefault" data-id="'+data+'"  class="btn btn-white btn-icon btn-xs g-br2 g-c-gray8">\
											<i class="fa-check"></i>\
											<span>设为默认</span>\
										</span>';
										}
		...
		function setDefault(obj){
			...
			$.ajax({
					url:"http://112.74.207.132:8081/mall-buzhubms-api/module/set/default",
					dataType:'JSON',
					method:'post',
					data:{
						id:id,
