            ...
            $.ajax({
                ...
                .done(function (resp) {
                    ...
                    if (code !== 0) {
                        ...
                        dia.content('<span class="g-c-bs-warning g-btips-warn">' + (resp.message || "查询地址失败") + '</span>').show();
                        return false;
                    }
                    /*是否是正确的返回数据*/
                    var res = resp.result;
        ...
        function getRegion(idobj, wrap, name) {
            ...
            $.ajax({
                ...
                .done(function (resp) {
                    ...
                    if (code !== 0) {
                        console.log(resp.message);
                        dia.content('<span class="g-c-bs-warning g-btips-warn">' + (resp.message || "查询归属地失败") + '</span>').show();
                        return false;
                    }
                    /*是否是正确的返回数据*/
                    var res = resp.result;
        ...
        function setWarehouseData(id) {
            ...
            $.ajax({
                ...
                .done(function (resp) {
                    ...
                    if (code !== 0) {
                        console.log(resp.message);
                        dia.content('<span class="g-c-bs-warning g-btips-warn">' + (resp.message || "修改设置值失败") + '</span>').show();
                        if (code === 999) {
