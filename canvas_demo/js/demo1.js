(function () {
    ...
    function init() {
        ...
        if (!self.canvas.getContext) {
            ...
            canvasContainerDisabled.style.backgroundColor = "#fff";
            canvasContainerDisabled.style.backgroundImage = "none";
            return;
        }
        /*self.canvas.onselectstart = function() {
            return false;
        };*/
        self.canvas.width = self.cw = 900;
    ...
    function createFireworks(startX, startY, targetX, targetY) {
    ...
    function canvasLoop() {
        RAF_Obj(self.canvasLoop, self.canvas);
        self.updateDelta();
