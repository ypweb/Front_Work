    ...
    $(function () {
        ...
        if (public_tool.initMap.isrender) {
            ...
            var powermap = public_tool.getPower(),
                advertadd_power = public_tool.getKeyPower('bzw-advert-add', powermap);
            ...
            if ($.isFunction($.fn.validate)) {
                        ...
                        $.extend(true, (function () {
                            ...
                            submitHandler: function (form) {
                                ...
                                if (formtype === 'advertadd') {
                                    ...
                                    if (ftype === 0 || ftype === 1) {
                                        setdata['forwardId'] = $admin_forwardId.attr('data-id');
                                    } else if (ftype === 2) {
                ...
                /*提交验证*/
                if (resetform0 === null) {
                    resetform0 = $admin_addadvert_form.validate(form_opt0);
                }
            }
        ...
        function getGoodsTypes(value, type, flag) {
            ...
            $.ajax({
                ...
                if (code !== 0) {
                    ...
                    dia.content('<span class="g-c-bs-warning g-btips-warn">' + (resp.message || "查询类型失败") + '</span>').show();
                    return false;
                }
